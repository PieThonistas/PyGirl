...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        id_ = dic['id_']
        user_answer = dic['user_answer']
        guessed_letter = dic['letter']
        if 'user_answer' in dic:
            url = f'localhost:3000/api/pygirl/'
            print(user_answer, id_)
            message = user_answer + " " + id_ + " " + guessed_letter + " "
...
class Game:
    ...
    # this checks if they have enough letters to win the game
